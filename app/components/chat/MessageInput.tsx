...
export default function MessageInput({
  ...
  return (
    <form
      ...
      className="flex-shrink-0 border-t border-spiritual-purple/30 bg-spiritual-dark/95 backdrop-blur-lg p-4 pb-[max(1rem,env(safe-area-inset-bottom))] shadow-lg"
    >
